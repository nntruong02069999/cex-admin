...
import styles from "./DepositListCtrl.module.css";
...
class ListCtrl extends Component<ListCtrlProps, ListCtrlState> {
  ...
  renderStatusTabs = () => {
    ...
    return (
      <div className={styles["deposit-status-container"]}>
        <div className={styles["deposit-tabs-title"]}>
        ...
        >
          ...
          <TabPane
            tab={renderTabLabel("Chờ thanh toán", statusCounts.PENDING)}
            key="PENDING"
          />
          <TabPane
            tab={renderTabLabel("Thành công", statusCounts.SUCCESS)}
            key="SUCCESS"
          />
          <TabPane
            tab={renderTabLabel("Thất bại", statusCounts.FAILED)}
            key="FAILED"
          />
        </Tabs>
      </div>
